...
model = YOLO(r"C:\Users\chara\OneDrive\Desktop\python projects\Car_Parking_Space_Detector_YOLOv8-main\yolov8n.pt")
model.to(device)

# Load the positions from the pickle file
with open(r'C:\Users\chara\OneDrive\Desktop\python projects\Car_Parking_Space_Detector_YOLOv8-main\Space_ROIs', 'rb') as f:
    posList = pickle.load(f)

# Capture from camera or video
cap = cv2.VideoCapture(r"C:\Users\chara\OneDrive\Desktop\python projects\Car_Parking_Space_Detector_YOLOv8-main\input_video\parking_space.mp4")  
# get vcap property
